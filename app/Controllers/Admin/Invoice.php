...
class Invoice extends BaseController
{
    ...
    public function downloadInvoice($id)
    {
        ...
        // print_r($html);die;
        try {
            // Create mPDF instance with A4 size and UTF-8 support
            $mpdf = new Mpdf([
                'mode' => 'utf-8',
                'format' => 'A4',
                'margin_left' => 10,
            ...
            $mpdf->SetTitle("Invoice #{$invoice['id']}");
            ...
            return redirect()->to('/invoice_list')->with('error', 'Failed to generate PDF: ' . $e->getMessage());
        }
    }
}
