                        ...
                        <div class="">
                            ...
                            <div class="flex items-center justify-between gap-3 mb-3 pb-2">
                                <div class="flex items-center w-full">
                                    <img src="<?= base_url().'assets/images/flags/flag1.png' ?>" alt="" class="w-10 h-10 rounded-full shrink-0 me-2 overflow-hidden">
                                    <div class="grow">
                            ...
                            <div class="flex items-center justify-between gap-3 mb-3 pb-2">
                                <div class="flex items-center w-full">
                                    <img src="<?= base_url().'assets/images/flags/flag2.png'?>" alt="" class="w-10 h-10 rounded-full shrink-0 me-2 overflow-hidden">
                                    <div class="grow">
                            ...
                            <div class="flex items-center justify-between gap-3 mb-3 pb-2">
                                <div class="flex items-center w-full">
                                    <img src="<?= base_url().'assets/images/flags/flag3.png'?>" alt="" class="w-10 h-10 rounded-full shrink-0 me-2 overflow-hidden">
                                    <div class="grow">
                            ...
                            <div class="flex items-center justify-between gap-3">
                                <div class="flex items-center w-full">
                                    <img src="<?= base_url().'assets/images/flags/flag4.png'?>" alt="" class="w-10 h-10 rounded-full shrink-0 me-2 overflow-hidden">
                                    <div class="grow">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mt-8">
                            ...
                            <div class="flex items-center justify-between gap-3 mb-8">
                                <div class="flex items-center">
                                    <img src="<?= base_url().'assets/images/users/user1.png'?>" alt="" class="w-10 h-10 rounded-full shrink-0 me-2 overflow-hidden">
                                    <div class="grow">
                            ...
                            <div class="flex items-center justify-between gap-3 mb-8">
                                <div class="flex items-center">
                                    <img src="<?= base_url().'assets/images/users/user2.png'?>" alt="" class="w-10 h-10 rounded-full shrink-0 me-2 overflow-hidden">
                                    <div class="grow">
                            ...
                            <div class="flex items-center justify-between gap-3 mb-8">
                                <div class="flex items-center">
                                    <img src="<?= base_url().'assets/images/users/user3.png'?>" alt="" class="w-10 h-10 rounded-full shrink-0 me-2 overflow-hidden">
                                    <div class="grow">
                            ...
                            <div class="flex items-center justify-between gap-3 mb-8">
                                <div class="flex items-center">
                                    <img src="<?= base_url().'assets/images/users/user4.png'?>" alt="" class="w-10 h-10 rounded-full shrink-0 me-2 overflow-hidden">
                                    <div class="grow">
                            ...
                            <div class="flex items-center justify-between gap-3 mb-8">
                                <div class="flex items-center">
                                    <img src="<?= base_url().'assets/images/users/user5.png'?>" alt="" class="w-10 h-10 rounded-full shrink-0 me-2 overflow-hidden">
                                    <div class="grow">
